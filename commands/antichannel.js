...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('antichannel')
        .setDescription('Gère les utilisateurs autorisés à créer des salons')
        ...
        switch (subcommand) {
            case 'ajouter': {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setDescription(`${user.tag} a été ajouté à la liste des utilisateurs autorisés à créer des salons.`)
                    .addFields(
            ...
            case 'retirer': {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setDescription(`${user.tag} a été retiré de la liste des utilisateurs autorisés à créer des salons.`)
                    .addFields(
                        { name: 'ID Utilisateur', value: user.id },
